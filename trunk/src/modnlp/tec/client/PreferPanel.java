	...
	implements  ActionListener, ItemListener, DefaultManager 
{
  ...
  private String HIDESGML = "Show SGML markup along with translated text";
  ...
  public PreferPanel (Browser mother){
    ...
    targFrame = mother;
    //prefer.setLayout(new GridLayout(9,2));
    ...
    //set6.setLayout(new GridLayout(2,1));
    ...
    set6a.add(new JLabel("Headers URL: "));
    set6a.add(headerBaseField);
